...
namespace Server_DAL
{
    ...
    public class DBHelper
    {
        ...
        private static string getConnStr()
        {
            ...
            {
                //if (ConnectionStr == "")
                //    ConnectionStr = ConfigurationManager.AppSettings["DBConnectionString"].ToString();
               // ConnectionStr = "server=127.0.0.1;User Id=root;password=libing;Database=zhizhangmanager";
               // ConnectionStr = "server=127.0.0.1;User Id=root;password=123456;Database=zngz";
                //ConnectionStr = "Database=zngz;Data Source=localhost;User Id=root;Password=123456;pooling=false;CharSet=utf8;port=3306";
                ConnectionStr = "Database=zngz;Data Source=112.74.213.160;User Id=root;Password=libing;pooling=false;CharSet=utf8;port=3306";
            }
            catch
            {
                return null;
        ...
        {
            Console.WriteLine("start insert11");
            MySqlCommand cmd = new MySqlCommand();
