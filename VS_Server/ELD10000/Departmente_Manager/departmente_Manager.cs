...
namespace Departmente_Manager
{
    public class departmente_Manager :IInterface.IInterface
    {
        string tableStr = "departments";
        ...
        public string Process(string xmlStr)
        {
            ...
            try
            {
                ...
                catch
                {
                    ...
                    return "<result " + GetUrlManager.getUrlManager(this.url()) + " err=\"E2006\"></result>";//xml格式错误
                }
        ...
        private string Delete(XmlNodeList nodeList)
        {
            ...
            try
            {
                for (int m = 0; m < nodeList.Count; m++)
                {
                    ...
                    ////数据检查
                    //if (Server_Public.Info_Check.info_Check(tableStr, dataDict) != "ID")
                    //{
                    //    return "ID错误";
                    //}
        ...
        private string Insert(XmlNodeList nodeList)
        {
            ...
            try
            {
                for (int m = 0; m < nodeList.Count; m++)
                {
                    ...
                    //读取ID
                    int ID = (int)ID_Manager.get_TxtId(@"departmentes.txt");
